...
2. **Index** : si `memoire/session/INDEX.md` n'existe pas, le créer depuis le [template INDEX](reference.md) § Template INDEX (adapter la légende de tags au projet). Sinon, ajouter une ligne **en haut** du tableau (date, tags — voir légende dans l'INDEX, titre lien, résumé une phrase). Ne pas modifier les lignes existantes.
